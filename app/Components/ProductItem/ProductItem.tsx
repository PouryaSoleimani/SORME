...
const ProductItem = ({ ...product }) => {
  AOS.init();
  return (
    <div id='ProductItemContainer' className='border-2 box-border border-zinc-300 rounded-xl pt-4 px-4  h-fit flex items-start justify-between space-x-16 hover:scale-110 cursor-pointer duration-300 hover:border-black animate__animated animate__pulse'>
      ...
      <div id="right" className='flex flex-col items-end justify-center py-0 h-[17rem]'>
        ...
        <p id="productPrice" className='text-pink-400 font-extrabold text-3xl -translate-x-[4.5rem] -translate-y-[2.1rem]'>{product.price}$</p>
      </div>
