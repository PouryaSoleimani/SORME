...
const ShoppingCartItem = ({ ...product }: SingleProductType) => {
  ...
  return (
    <section className='flex'>
      <div id='ProductItemContainer' className='border-2 box-border border-zinc-300 rounded-xl pt-5 px-4 w-fit h-fit flex  hover:scale-110 cursor-pointer duration-300 hover:border-black animate__animated animate__pulse'>
