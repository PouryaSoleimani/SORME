...
const HomeSwiper = () => {
  return (
    <div className='py-6 px-4 w-screen'>
      <Swiper spaceBetween={30} rewind={true} centeredSlides={true} grabCursor={true} autoplay={{ delay: 3000, disableOnInteraction: false }} navigation={true} loop={true} modules={[Autoplay, Navigation]} className="mySwiper">
