...
const HomeOptions = () => {
  return (
    <div className='flex items-center justify-around px-14' data-aos="fade-up" data-aos-duration="600" data-aos-easing="linear" data-aos-anchor-placement="top-bottom">
