...
const ShoppingCartSideBar = () => {
  ...
  useEffect(() => {
    if (prices.length) {
      let sum = prices.reduce((a: number, b: number) => a + b)
      setTotalCheck(sum)
    }
  }, [])
  ...
  return (
    <div className='w-2/5 h-screen bg-zinc-200 border-l-8 border-pink-300 px-10'>
      ...
      <p className='text-3xl font-bold text-emerald-700 my-4 bg-lime-300 px-4 py-2 rounded-xl'> Total Check : {totalCheck * 110 / 100}</p>
