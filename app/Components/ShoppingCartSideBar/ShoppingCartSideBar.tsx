...
const ShoppingCartSideBar = () => {
  ...
  return (
    <div className='w-2/5 h-screen bg-zinc-200 border-l-8 border-pink-300 px-10'>
      ...
      <span className='text-xl font-bold mt-24 mb-4'>Items Count : {BAG?.length}</span>
      <p className='text-xl font-bold text-blue-700 my-4'>Total Item Prices : ${totalCheck}</p>
      <p className='text-xl font-bold my-4 text-zinc-500'>Tax : 10%</p>
      <p className='text-3xl font-bold text-emerald-700 my-4 bg-emerald-200 p-6 border-b-4 border-emerald-700 rounded-xl'> Total Check : ${totalCheck * 110 / 100}</p>
