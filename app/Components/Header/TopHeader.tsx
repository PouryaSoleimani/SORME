...
const TopHeader = () => {
  return (
    <div className='bg-[url("/images/header/HeaderTopBackGround.png")] w-screen h-[38px] bg-cover bg-no-repeat flex items-center justify-between px-[22rem] overflow-hidden' >
