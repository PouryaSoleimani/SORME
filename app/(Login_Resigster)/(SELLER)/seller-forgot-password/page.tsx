      ...
      <div id="form_container" className="w-[33rem] h-fit bg-[#F29AA7] rounded-3xl flex flex-col px-2">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-6 space-y-6  px-4'>
          ...
          <span className='flex flex-col'>
            ...
            <input type="text" placeholder='Hardy.Oppenh' {...register("username")} className='px-5 py-3 z-0 border-4 placeholder:text-xl relative left-0 placeholder:text-white border-white bg-transparent rounded-lg w-full text-3xl text-white font-semibold' />
