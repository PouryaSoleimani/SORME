...
const ForgotPasswordGetPasswordPage = ({ }) => {
  //YUP
    ...
    <div className="flex items-center justify-center w-screen h-screen">
      <div id="form_container" className="w-[33rem] h-fit bg-[#F29AA7] rounded-3xl flex flex-col px-2">
        ...
        <div id="form_top" className="mt-10 flex items-center justify-between pr-6 pl-0">
          ...
          <img src="/images/forms/Forms_Top_Logo.png" className="w-[6rem] h-6 -translate-y-1" />
        </div>
        {/* FORM MAIN -----------------------------------------------------------------------------------------------------  */}
...
export default ForgotPasswordGetPasswordPage